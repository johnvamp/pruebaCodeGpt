...
public class GuardarCmd implements IBaseCmd {
	...
	private void obtenerDatos(HttpServletRequest req) {
		...
		descripcion = req.getParameter("descripcion") != null ? req.getParameter("descripcion") : "";
