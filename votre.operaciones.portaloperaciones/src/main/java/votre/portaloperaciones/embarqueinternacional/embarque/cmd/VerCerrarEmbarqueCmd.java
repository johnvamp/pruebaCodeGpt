...
public class VerCerrarEmbarqueCmd implements IBaseCmd {
		...
		try{
			...
			if(embarqueDTO != null){
				if(embarqueDTO.getEstado().equals(Constantes.EXITO_SP)){
					...
					req.setAttribute("titCerrar", embarqueDTO.getTitCerrar());
