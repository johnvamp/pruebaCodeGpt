...
<body onload="mostrarMensaje('${mensaje}');" ondragenter="cancelEvent()" ondragover="cancelEvent()">
	<div id="url">
		<h2>Embarque Internacional / <span>Entregar Embarque por Archivo</span> </h2>
	</div>
					    ...
					    <tr>
					        ...
					        <td class="bgcajaGris">
					        	<table width="100%" border="0" cellspacing="1" cellpadding="2">
					        		<tr>
					        			<td class="titulosContenido" align="center">Seleccione el Archivo:
					        				<input type="file" name="archivo" id="archivo" size="50" style="cursor: pointer;">
					        			</td>
					        		</tr>
					        		<tr>
										<td align="center" colspan="2">
											<input type="button" class="boton01" name="btnProcesar" id="btnProcesar" style="cursor: pointer;" onclick="procesar();" value="PROCESAR" />
											<input type="button" class="boton01" name="btnRegresar" id="btnRegresar" style="cursor: pointer;" onclick="regresar();" value="REGRESAR" />
										</td>
									</tr>
					        	</table>
					         <td class="bgcajaGris">&nbsp;</td>
