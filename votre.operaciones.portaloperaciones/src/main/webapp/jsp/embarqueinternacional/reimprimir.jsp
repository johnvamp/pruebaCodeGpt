...
<script type="text/javascript" src="js/embarqueinternacional/reimprimir.js"></script>
...
<body onload="mostrarMensaje('${mensaje}');" ondragenter="cancelEvent()" ondragover="cancelEvent()">
					        	...
					        	<table width="100%" border="0" cellspacing="1" cellpadding="2">
					        			...
					        			<td width="50%">
					        				<select id="transportador" name="transportador" class="combo03">
												...
												<c:forEach items="${transportadores}" var="trans">
													<option value="${trans.codTransportador}" >${trans.transportador}</option>
												</c:forEach>
					        				</select>
					        			</td>
					        		</tr>
					        		...
					        		<tr>
										<td align="center" colspan="2">
											<input type="button" class="boton01" name="btnAceptar" id="btnAceptar" style="cursor: pointer;" onclick="validarReimpresion();" value="${titReimprimir}" />
	...
	<ajax:select baseUrl="reimprimir.consultarCamionesReimprimir.do" source="transportador"
