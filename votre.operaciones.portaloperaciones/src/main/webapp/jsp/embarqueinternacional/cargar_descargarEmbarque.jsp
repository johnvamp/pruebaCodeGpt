...
<script type="text/javascript" src="js/embarqueinternacional/cargar_descargarEmbarque.js"></script>
...
<body onload="javascript:load();mostrarMensaje('${mensaje}');" ondragenter="cancelEvent()" ondragover="cancelEvent()">
	...
	<form name="forma" method="post">
		...
		<input type="hidden" id="ejecutarAccion" name="ejecutarAccion" value="${accion}" />
		<table align="center">
			<tr>
				<td align="center">
					        ...
					        <td class="bgcajaGris">
					        	<table width="100%" border="0" cellspacing="1" cellpadding="2">
					        		...
					        		<tr>
					        			...
					        			<td>
					        				<input type="text" id="txtOrden" name="txtOrden" class="campo02" onkeypress="return validaIngresoNum2(event);" maxlength="11" />
					        			</td>
					        		</tr>
					        		<tr>
										<td align="center" colspan="2">
											<input type="button" class="boton01" name="btnAceptar" id="btnAceptar" style="cursor: pointer;" onclick="validarOrden('${accion}');" value="${titAceptar}" />
											<c:choose>
												<c:when test="${accion == 'embarcar'}">
													<input type="button" class="boton01" name="btnDetener" id="btnDetener" style="cursor: pointer;" onclick="detenerEmbarque();" value="${titDetener}" />
												...
												<c:otherwise>
													<input type="button" class="boton01" name="btnFinalizar" id="btnFinalizar" style="cursor: pointer;" onclick="regresar()" value="${titRegresar}" />
												</c:otherwise>
											</c:choose>
										</td>
									</tr>
