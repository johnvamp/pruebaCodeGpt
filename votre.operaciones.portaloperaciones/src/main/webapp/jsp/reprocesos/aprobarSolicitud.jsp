...
<body onload="calendario2();" bgcolor="#f4f4f4">
	<form name="forma" method="post">
		<table width="60%" height="250" border="0" align="center" cellpadding="0" cellspacing="0">
					    ...
					    <tr>
					        ...
					        <td class="bgcajaGris">
					        	<table width="330" height="100" border="0" cellpadding="0" cellspacing="0" align="center">
					        		<tr>
										<td colspan="2" width="100%" align="center" class="titulos">Aprobar Solicitud</td>
									</tr>
									<tr>
	    	...
	    	<tr>
	    		<td align="center">
	    			<input type="button" class="boton01" id="bntGuardar" name="btnGuardar" value="GUARDAR" onclick="aprobarSolicitud()" />
	    		</td>
	    	</tr>				       
		</table>
	</form>
