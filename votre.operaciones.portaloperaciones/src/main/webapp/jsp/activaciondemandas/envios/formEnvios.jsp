...
<script type="text/javascript" src="js/activaciondemandas/envios/formEnvios.js"></script>
...
<body onload="mostrarMensaje('${mensaje}');" ondragenter="cancelEvent()" ondragover="cancelEvent()">
	<div id="url">
		<h2>Activación de la Demanda / <span>Envíos Manuales</span> </h2>
	</div>
					        	...
					        	<table width="100%" border="0" cellspacing="1" cellpadding="2">
					        		...
					        		<tr>
										<td align="center" colspan="2">
											...
											<input type="button" class="boton01" name="btnExcel" id="btnExcel" style="cursor: pointer;" onclick="return consultarEnvios('${SELECCION_TODO}','S','1');" value="GENERAR EXCEL" />
										</td>
									</tr>
					        	</table>
					        </td>
						        ...
						        <td class="bgcajaGris">
						        	<table width="100%" border="0" cellspacing="1" cellpadding="2">
						        		<tr>
						        			...
						        			<th width="3%" class="tituloTablaFijos">Campaña Premio</th>
						        			<th width="9%" class="tituloTablaFijos">SKU</th>
						        			<th width="8%" class="tituloTablaFijos">Descripción</th>
						        			<th width="5%" class="tituloTablaFijos">Motivo</th>
						        			<th width="9%" class="tituloTablaFijos">SKU Sustituto</th>
						        			<th width="3%" class="tituloTablaFijos">Cant Entregada</th>
						        			<th width="3%" class="tituloTablaFijos">Tipo Despacho</th>
						        		...
						        		<c:forEach items="${envios}" var="det" varStatus="fila">
							        		...
							        		<tr id="tr_${fila.count}" class="filaTabla11">
							        			...
							        			<td class="${fila.count % 2 == 0 ? 'cel1' : 'cel2'}">
							        				<input type="text" id="txtGuia_${fila.count}" name="txtGuia_${fila.count}" value="" class="campoW" maxlength="15" size="12" onkeypress="return validarTextoGeneral(event);"/>
						        				</td>
							        			<td class="${fila.count % 2 == 0 ? 'cel1' : 'cel2'}">
							        			...
							        			<td class="${fila.count % 2 == 0 ? 'cel1' : 'cel2'}">
							        				<input type="text" id="txtFecha_${fila.count}" name="txtFecha_${fila.count}" value="" class="campoW" maxlength="10" size="8" readonly="readonly"/>
							        			...
							        			<td class="${fila.count % 2 == 0 ? 'cel1' : 'cel2'}">
							        				<div id="divProcesar_${fila.count}">
								        				<a href="javascript:realizarEnvio('${fila.count}')">
								        					<img src="imagenes/ico_guardar.png" border="0" width="14" height="14" title="Enviar"/>
								        				</a>
							        				</div>
							        			</td>
							        		</tr>
