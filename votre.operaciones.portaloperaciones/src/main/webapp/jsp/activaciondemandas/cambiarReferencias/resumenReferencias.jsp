					    ...
					    <tr>
					        ...
					        <td class="bgcajaGris">
					        	<table width="100%" border="0" cellspacing="1" cellpadding="2">	
					        		...
					        		<tr>
					        			<td align="center">
					        				<span class="titulosContenido">Resumen referencias seleccionadas</span>
					        			</td>
					        		</tr>
					        		<tr>
					        			<td height="15"></td>
					        		...
					        		<tr>
					        			<td align="center">
					        				<input type="button" id="btnRegresar" name="btnRegresar" class="boton01" value="REGRESAR" onclick="regresar()" />
					        			</td>
					        		</tr>
					        	</table>
					        </td>
