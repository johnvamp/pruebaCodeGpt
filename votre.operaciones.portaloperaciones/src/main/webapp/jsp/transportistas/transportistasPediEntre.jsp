...
<script type="text/javascript"
	src="jsp/transportistas/transportistasPediEntre.js"></script>
...
<body>
	<div id="url">
		<h2>Transportistas / Pedidos Entregados</h2>
	</div>
	<form name="form" method="post">
		...
		<table>
			...
			<tr>
				...
				<td><input type="button" class="boton01" onclick="javascript:buscarTransportista('E','')" value="Buscar"/></td>
							...
							<td class="tablesinbor">
								<table width="100%">
									<tr>
										...
										<td><input type="button" class="boton01" onclick="buscarTransportista('E','G')" value="Buscar"/></td>
									</tr>
								</table>
							</td>
							<td class="tablesinbor">
								<table width="100%">
									<tr>
										<td><input class="required" type="text"
											...
											onkeypress="return validaIngresoNum(event);" /></td>
										<td><input type="button" class="boton01" onclick="buscarTransportista('E','C')" value="Buscar" /></td>
									</tr>
								</table>
							</td>
							<td class="tablesinbor">
								<table width="100%">
									<tr>
										<td><input maxlength="3" class="required" type="text"
											...
											onkeypress="return validaIngresoNum(event);" /></td>
										<td><input type="button" class="boton01" onclick="buscarTransportista('E','')" value="Buscar" /></td>
									</tr>
								</table>
							</td>
						</tr>
						...
						<table HEIGHT="50" width="100%" border="0" cellspacing="0"
							...
							<tr>
								<td align="center"><a class="boton01"
									href="javascript:generarExcel('E')">Exportar a Excel</a></td>
							</tr>
						</table>
