...
<body onload="mostrarMensaje('${mensaje}');">
	...
	<input type="hidden" id="numOrden" name="numOrden" value="${numOrden}" />
					        	...
					        	<table width="100%" border="1" cellpadding="0" cellspacing="0" align="center">
					        		<thead>
						        		<tr class="tituloTabla">
						        			...
						        			<td>Guia Reempaque</td>
						        		</tr>
						        	</thead>
						        	<tbody>
						        		<c:forEach items="${datos.arrPedidos}" var="detalle">
						        			<tr class="filaTabla">
						        				...
						        				<td>${detalle.fechaEmbarque}</td>
						        				<td>${detalle.guiaReempaque}</td>
						        			</tr>
						        		</c:forEach>
						        	</tbody>
					        	</table>
		...
		<table width="60%" border="0" align="center" cellpadding="0" cellspacing="0">
			<tr>
				<td align="center">
					<input type="button" class="boton01" value="AUDITORIA" onclick="consultarAuditoriaSolicitud();"/>
					<input type="button" class="boton01" value="REGRESAR" onclick="regresarListaSolicitudes();"/>
				</td>
			</tr>
			<tr>
	    		<td height="10"></td>
