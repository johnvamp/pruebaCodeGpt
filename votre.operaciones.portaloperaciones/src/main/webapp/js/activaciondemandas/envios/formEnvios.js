function consultarEnvios(todos,excel,pag)
{
	...
	forma.action = "activaciondemandas.consultarEnviosManuales.do";
	mostrarCargar();
	if(excel != ""){
		verificarDesbloqueo();
	}
...
function realizarEnvio(pos){
	...
	var url = "activaciondemandas.procesarEnvioManualAjax.do";
